...
const CartModal = () => {
  ...
  return (
    <div className="absolute top-10 right-2 w-[95%] left-1/2 -translate-x-1/2 md:left-auto md:translate-x-0 md:right-0 md:-top-12 md:w-90 bg-white rounded-xl shadow-2xl z-50 overflow-hidden">
      ...
      <div className="p-6 min-h-48 flex flex-col justify-center">
        {cartItems.length > 0 ? (
          <>
            ...
            <Button className="md:w-full py-4">Checkout</Button>
          </>
        ) : (
